...
<body class='login'>
	<div class="wrapper">
		<h1>
			<a href="{{""|u}}">
				<img src="{{"static/img/logo-big.png"|u}}" alt="" class='retina-ready' width="59" height="49">{{.context.Sitename}}</a>
		</h1>
		{{if .flash.error}}
			...
			<form action="{{""|u}}" method='post' class='form-validate' id="test">
				<div class="form-group">
					<div class="email controls">
						<input type="text" name='uemail' placeholder="邮箱地址" class='form-control' data-rule-required="true" data-rule-email="true">
					</div>
				</div>
				<div class="form-group">
					<div class="pw controls">
						<input type="password" name="upw" placeholder="密码" class='form-control' data-rule-required="true">
					</div>
				</div>
				<div class="submit">
					<div class="remember">
