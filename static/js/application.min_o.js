...
function checkLeftNav() {
    ...
    if (e.width() <= 840) {
        ...
        $(".toggle-mobile").length == 0 && $("#navigation .user").before(
...
$(document).ready(function () {
    ...
    $(".main-nav > li, .subnav-menu > li").hover(function () {
        if ($(this).attr("data-trigger") == "hover") if ($(this).parents(".subnav-menu").length > 0 && $("#left").hasClass(
                "sidebar-fixed")) $(this).find(">a").trigger("click");
            else {
    ...
    $(".content-slideUp").click(function (e) {
        ...
        n.slideToggle("fast", function () {
            ...
            t.find("i").hasClass("icon-angle-up") ? n.hasClass("scrollable") && destroySlimscroll(n) : n.hasClass(
                "scrollable") && slimScrollUpdate(n)
        })
    });
    $(".content-remove").click(function (e) {
        ...
        bootbox.animate(!1);
        bootbox.confirm("Do you really want to remove the widget <strong>" + t.parents(".box-title").find("h3").text() +
            "</strong>?", "Cancel", "Yes, remove", function (e) {
            if (e) if ($(".container-fluid").hasClass("sortable-box")) t.parents(".box").remove();
                else {
    ...
    $(".new-task-form").submit(function (e) {
        ...
        if (i.val() != "") {
            ...
            o +=
                '<div class="check"><input type="checkbox" class="icheck-me" data-skin="square" data-color="blue"></div><span class="task"><i class="' +
                r.select2("val") + '"></i><span>' + i.val() +
                '</span></span><span class="task-actions"><a href="#" class="task-delete" rel="tooltip" title="Delete that task"><i class="icon-remove"></i></a><a href="#" class="task-bookmark" rel="tooltip" title="Mark as important"><i class="icon-bookmark-empty"></i></a></span></li>';
            n.find(".bookmarked").length > 0 ? s.is(":checked") ? n.find(".bookmarked").first().before(o) : n.find(
                ".bookmarked").last().after(o) : n.prepend(o);
            icheck();
...
$(window).scroll(function (e) {
    ...
    if (n.scrollTop() == 0 || $("#left").hasClass("sidebar-fixed")) $("#left .ui-resizable-handle").css("top", t);
        ...
        n.scrollTop() + $("#left .ui-resizable-handle").height() <= r.height() ? t = n.scrollTop() - 40 : t = r.height() -
            $("#left .ui-resizable-handle").height() - 40;
        $("#left .ui-resizable-handle").css("top", t)
    }!$("#content").hasClass("nav-fixed") && $("#left").hasClass("sidebar-fixed") && (n.scrollTop() < 40 ? $("#left").css(
        "top", 40 - n.scrollTop()) : $("#left").css("top", 0));
    getSidebarScrollHeight();
    resizeHandlerHeight()
});
